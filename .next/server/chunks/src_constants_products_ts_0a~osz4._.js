module.exports=[45901,e=>{"use strict";let a=`
...
8. VERIFICACION DE NOMBRES Y CARGOS. Cuando menciones a un funcionario publico, autoridad o persona con cargo, NOMBRA EXACTAMENTE como aparece en las menciones fuente. NUNCA cambies el nombre de una persona, NI INVENTES nombres que no esten en las menciones, NI ALTERES el genero de un cargo (ejemplo: si la mencion dice "la ministra Beatriz Garcia", NO escribas "el ministro Ren\xe9 Garcia"). Si la mencion dice "ministra" es FEMENINO, si dice "ministro" es MASCULINO. Respecta EXACTAMENTE el nombre completo, cargo y genero que aparece en las menciones fuente.
...
- Mencionar fuentes por nombre en cada dato`,SALDO_DEL_DIA:`${a}
...
- Cerrar con un resumen de lo observado basado UNICAMENTE en las menciones del dia`,EL_FOCO:`${a}
...
- Fechas en formato es-BO (America/La_Paz)
- Profundidad academica pero accesible, sin inventar contexto historico`,EL_ESPECIALIZADO:`${a}
...
- Fechas en formato es-BO (America/La_Paz)
- No agregar contexto sectorial externo`,EL_INFORME_CERRADO:`${a}
...
- Fechas en formato es-BO (America/La_Paz)`,FICHA_LEGISLADOR:`${a}
...
- Fechas en formato es-BO (America/La_Paz)
- No emitir juicios de valor politico`,BOLETIN_DEL_GRANO:`${a}
...
- Conexiones entre ejes SOLO si las menciones lo justifican`,ALERTA_TEMPRANA:`${a}
...
- Indicar nivel de urgencia basado en las menciones`,EL_RADAR:`${a}
...
- Fechas en formato es-BO (America/La_Paz)`,VOZ_Y_VOTO:`${a}
...
- Fechas en formato es-BO (America/La_Paz)`,EL_HILO:`${a}
...
- Solo usar datos proporcionados
- Fechas en formato es-BO (America/La_Paz)`,FOCO_DE_LA_SEMANA:`${a}
...
- Solo usar datos proporcionados
- Fechas en formato es-BO (America/La_Paz)`},i={EL_TERMOMETRO:{tipo:"EL_TERMOMETRO",nombre:"El Termómetro",nombreCorto:"Termómetro",descripcion:"Boletín matutino que abre la jornada con indicador de clima mediático, alertas tempranas y lo que hay que observar.",categoria:"premium",frecuencia:"diario_am",horarioEnvio:"07:00 AM",longitudPaginas:1,longitudMinLectura:2,canales:["whatsapp","email"],periodoDefault:1,palabrasObjetivo:350,temperatura:0,activo:!0,generador:{tipo:"dedicado",ventana:"nocturna",filtros:["fecha","ejes"],requierePreview:!0,panelId:"termometro_saldo",descripcionVentana:"Ayer 19:00 — Hoy 07:00"},systemPrompt:o.EL_TERMOMETRO},SALDO_DEL_DIA:{tipo:"SALDO_DEL_DIA",nombre:"El Saldo del Día",nombreCorto:"Saldo",descripcion:"Cierre de jornada: resumen de evolución en la jornada y balance de los ejes temáticos contratados al finalizar la jornada (7:00 PM).",categoria:"premium",frecuencia:"diario_pm",horarioEnvio:"07:00 PM",longitudPaginas:1,longitudMinLectura:2,canales:["whatsapp","email"],periodoDefault:1,palabrasObjetivo:450,temperatura:0,activo:!0,generador:{tipo:"dedicado",ventana:"diurna",filtros:["fecha","ejes"],requierePreview:!0,panelId:"termometro_saldo",descripcionVentana:"Hoy 07:00 — 19:00"},systemPrompt:o.SALDO_DEL_DIA},EL_FOCO:{tipo:"EL_FOCO",nombre:"El Foco",nombreCorto:"Foco",descripcion:"Análisis profundo diario de un eje temático específico. El cliente elige qué ejes monitorear (1, 3, 5 o los 11).",categoria:"premium",frecuencia:"diario_am",horarioEnvio:"09:00 AM",longitudPaginas:2,longitudMinLectura:5,canales:["whatsapp","email","pdf"],periodoDefault:1,palabrasObjetivo:800,temperatura:.1,activo:!0,generador:{tipo:"dedicado",ventana:"dia_completo",filtros:["fecha","ejes"],requierePreview:!0,panelId:"foco",tieneFases:!0,descripcionVentana:"Día completo (00:00 — 23:59)"},systemPrompt:o.EL_FOCO},EL_ESPECIALIZADO:{tipo:"EL_ESPECIALIZADO",nombre:"El Especializado",nombreCorto:"Especializado",descripcion:"Análisis experto sectorial con datos duros y contexto verificado. Para clientes institucionales que necesitan profundidad.",categoria:"premium_mid",frecuencia:"diario",horarioEnvio:"10:00 AM",longitudPaginas:4,longitudMinLectura:10,canales:["email","pdf"],periodoDefault:1,palabrasObjetivo:1800,temperatura:.2,activo:!0,generador:{tipo:"dedicado",endpoint:"/api/admin/bulletins/generate-especializado",ventana:"2dias",filtros:["sector","fecha","pesoEje"],requierePreview:!1,freemium:{activo:!0,modo:"rotacion_diaria",descripcion:"Un sector rota diariamente de forma automática (gratuito). Clientes pagantes pueden solicitar sector específico."},panelId:null},systemPrompt:o.EL_ESPECIALIZADO},EL_INFORME_CERRADO:{tipo:"EL_INFORME_CERRADO",nombre:"El Informe Cerrado",nombreCorto:"Informe",descripcion:"Análisis profundo semanal. Incluye tendencias, ranking de actores y consolidación de datos de la semana.",categoria:"premium",frecuencia:"semanal",horarioEnvio:"Lunes 10:00 AM",longitudPaginas:6,longitudMinLectura:15,canales:["email","pdf"],periodoDefault:7,palabrasObjetivo:2200,temperatura:.2,activo:!0,generador:{tipo:"generico",ventana:"semanal",filtros:["fecha","ejes","actores"],requierePreview:!1,panelId:null,descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.EL_INFORME_CERRADO},EL_RADAR:{tipo:"EL_RADAR",nombre:"El Radar",nombreCorto:"Radar",descripcion:"Boletín semanal gratuito con radar de los 11 ejes temáticos. Para masa extensa: legisladores, periodistas, ONGs, academia.",categoria:"gratuito",frecuencia:"semanal",horarioEnvio:"Lunes 08:00 AM",longitudPaginas:1.5,longitudMinLectura:3,canales:["email","web"],periodoDefault:7,palabrasObjetivo:500,temperatura:0,activo:!0,generador:{tipo:"dedicado",ventana:"semanal",filtros:["fecha"],requierePreview:!0,panelId:"radar",descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.EL_RADAR},VOZ_Y_VOTO:{tipo:"VOZ_Y_VOTO",nombre:"Voz y Voto",nombreCorto:"Voz y Voto",descripcion:"Resumen legislativo semanal gratuito. Actividad parlamentaria, votaciones clave, presencia mediática de legisladores.",categoria:"gratuito",frecuencia:"semanal",horarioEnvio:"Lunes 08:00 AM",longitudPaginas:1,longitudMinLectura:2,canales:["email","web"],periodoDefault:7,palabrasObjetivo:600,temperatura:.3,activo:!0,generador:{tipo:"generico",ventana:"semanal",filtros:["fecha"],requierePreview:!1,panelId:null,descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.VOZ_Y_VOTO},EL_HILO:{tipo:"EL_HILO",nombre:"El Hilo",nombreCorto:"El Hilo",descripcion:"Recuento narrativo semanal gratuito. La historia de la semana contada como hilo conductor.",categoria:"gratuito",frecuencia:"semanal",horarioEnvio:"Lunes 08:00 AM",longitudPaginas:1,longitudMinLectura:2,canales:["email","web"],periodoDefault:7,palabrasObjetivo:700,temperatura:.1,activo:!0,generador:{tipo:"generico",ventana:"semanal",filtros:["fecha"],requierePreview:!1,panelId:null,descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.EL_HILO},FOCO_DE_LA_SEMANA:{tipo:"FOCO_DE_LA_SEMANA",nombre:"Foco de la Semana",nombreCorto:"Foco Semanal",descripcion:"Radar temático semanal gratuito. Cada semana un eje diferente: qué pasó, quién dijo qué, qué sigue. Puerta de entrada a los productos temáticos premium.",categoria:"gratuito",frecuencia:"semanal",horarioEnvio:"Lunes 08:00 AM",longitudPaginas:.5,longitudMinLectura:2,canales:["email","web"],periodoDefault:7,palabrasObjetivo:600,temperatura:.1,activo:!0,generador:{tipo:"generico",ventana:"semanal",filtros:["fecha","ejes"],requierePreview:!1,panelId:null,descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.FOCO_DE_LA_SEMANA},ALERTA_TEMPRANA:{tipo:"ALERTA_TEMPRANA",nombre:"Alerta Temprana",nombreCorto:"Alerta",descripcion:"Alertas en tiempo real por WhatsApp. Detección temprana de crisis, picos de sentimiento negativo y eventos relevantes. Solo para clientes premium.",categoria:"premium_alta",frecuencia:"tiempo_real",horarioEnvio:"Inmediata",longitudPaginas:0,longitudMinLectura:1,canales:["whatsapp"],periodoDefault:30,palabrasObjetivo:160,temperatura:.3,activo:!0,generador:{tipo:"generico",ventana:"estandar",filtros:["fecha","ejes","actores"],requierePreview:!1,panelId:null},systemPrompt:o.ALERTA_TEMPRANA},FICHA_LEGISLADOR:{tipo:"FICHA_LEGISLADOR",nombre:"Ficha del Legislador",nombreCorto:"Ficha",descripcion:"Informe individual de presencia mediática de un legislador. A solicitud del propio legislador o su equipo.",categoria:"premium",frecuencia:"bajo_demanda",horarioEnvio:"Bajo demanda",longitudPaginas:1,longitudMinLectura:2,canales:["email","pdf"],periodoDefault:30,palabrasObjetivo:1e3,temperatura:.3,activo:!0,generador:{tipo:"generico",ventana:"estandar",filtros:["actores"],requierePreview:!1,panelId:null,descripcionVentana:"Período personalizable"},systemPrompt:o.FICHA_LEGISLADOR},BOLETIN_DEL_GRANO:{tipo:"BOLETIN_DEL_GRANO",nombre:"Boletín del Grano",nombreCorto:"El Grano",descripcion:"Reporte semanal especializado en café de especialidad boliviano. Cubre la cadena productiva completa: precios, clima, regulación, logística, innovación, ferias y contexto.",categoria:"premium_mid",frecuencia:"semanal",horarioEnvio:"Lunes 08:00 AM",longitudPaginas:5,longitudMinLectura:10,canales:["email","pdf"],periodoDefault:7,palabrasObjetivo:1800,temperatura:.1,activo:!0,generador:{tipo:"generico",ventana:"semanal",filtros:["fecha"],requierePreview:!1,panelId:null,descripcionVentana:"Semana completa (lunes — domingo)"},systemPrompt:o.BOLETIN_DEL_GRANO}};Object.values(i).filter(e=>e.activo),Object.values(i).filter(e=>"gratuito"!==e.categoria),Object.values(i).filter(e=>"gratuito"===e.categoria);let n=Object.values(i).filter(e=>"dedicado"===e.generador.tipo);Object.values(i).filter(e=>"generico"===e.generador.tipo),e.s(["ETIQUETAS_ENTREGA",0,{EL_TERMOMETRO:{whatsapp:"🌡️ EL TERMÓMETRO — {fecha}",email:"El Termómetro — {fecha} | DECODEX"},SALDO_DEL_DIA:{whatsapp:"📊 EL SALDO DEL DÍA — {fecha}",email:"El Saldo del Día — {fecha} | DECODEX"},EL_FOCO:{whatsapp:"🔍 EL FOCO — {eje} — {fecha}",email:"El Foco: {eje} — {fecha} | DECODEX"},EL_ESPECIALIZADO:{whatsapp:"📋 EL ESPECIALIZADO — {sector} — {fecha}",email:"El Especializado: {sector} — {fecha} | DECODEX"},EL_RADAR:{whatsapp:"📡 EL RADAR — Semana {semana}",email:"El Radar — Semana del {inicio} al {fin} | DECODEX"},EL_INFORME_CERRADO:{whatsapp:"📄 EL INFORME CERRADO — Semana {semana}",email:"El Informe Cerrado — Semana {semana} | DECODEX"},VOZ_Y_VOTO:{whatsapp:"🗳️ VOZ Y VOTO — Semana {semana}",email:"Voz y Voto — Semana {semana} | DECODEX"},EL_HILO:{whatsapp:"🧵 EL HILO — Semana {semana}",email:"El Hilo — Semana {semana} | DECODEX"},FICHA_LEGISLADOR:{whatsapp:"📋 FICHA — {legislador} | DECODEX",email:"Ficha del Legislador: {legislador} | DECODEX"},FOCO_DE_LA_SEMANA:{whatsapp:"🔍 FOCO DE LA SEMANA — {eje} — Semana {semana}",email:"Foco de la Semana: {eje} — Semana {semana} | DECODEX"},ALERTA_TEMPRANA:{whatsapp:"🚨 ALERTA TEMPRANA — {evento}",email:"Alerta Temprana: {evento} | DECODEX"},BOLETIN_DEL_GRANO:{whatsapp:"☕ BOLETÍN DEL GRANO — Semana {semana}",email:"Boletín del Grano: Café de Especialidad Bolivia — Semana del {inicio} al {fin} | DECODEX"}},"PRODUCTOS",0,i,"PRODUCTOS_DEDICADOS",0,n])}];

//# sourceMappingURL=src_constants_products_ts_0a~osz4._.js.map