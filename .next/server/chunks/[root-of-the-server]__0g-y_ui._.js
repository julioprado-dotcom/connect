module.exports=[463021,(e,t,a)=>{t.exports=e.x("@prisma/client-2c3a283f134fdcb6",()=>require("@prisma/client-2c3a283f134fdcb6"))},843793,e=>{"use strict";var t=e.i(463021);let a=globalThis,n=process.cwd();process.env.DATABASE_URL=`file:${n+"/prisma/db/custom.db"}`;let i=a.prisma??new t.PrismaClient;a.prisma||(a.prisma=i),e.s(["default",0,i])},429742,e=>{"use strict";function t(){let e=new Date;return new Date(e.getTime()+6e4*e.getTimezoneOffset()+-144e5)}function a(){let e=t();return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()))}e.s(["boliviaDaysAgo",0,function(e){return new Date(a().getTime()-24*e*36e5)},"boliviaEndOfDay",0,function(){return new Date(a().getTime()+864e5-1)},"boliviaNow",0,t,"boliviaStartOfDay",0,a,"boliviaStartOfMonth",0,function(){let e=t();return new Date(Date.UTC(e.getFullYear(),e.getMonth(),1))},"boliviaStartOfWeek",0,function(){let e=t(),a=e.getDay();return new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()-(0===a?6:a-1)))},"boliviaStartOfYesterday",0,function(){return new Date(a().getTime()-864e5)},"formatFechaBolivia",0,function(e){return e.toLocaleDateString("es-BO",{day:"numeric",month:"long",year:"numeric",timeZone:"America/La_Paz"})}])},446139,e=>{"use strict";var t=e.i(843793),a=e.i(463021),n=e.i(45901),i=e.i(429742);async function o(e,n={}){let{fechaInicio:i,fechaFin:c}=r(e),l=i.getTime(),s=c.getTime(),d=a.Prisma.sql`
...
</html>`),{tipo:p,canal:u,destinatarios:g,asunto:e,contenido:h,contenidoFormateado:"whatsapp"===u?function(e,t=1600){return e.length<=t?e:e.slice(0,t-60)+"\n\n📎 *Continúa en el informe completo:* [enlace]"}(y):y}),C=await t.default.entrega.create({data:{contratoId:s,tipoBoletin:l,contenido:v.contenidoFormateado,estado:"enviado",canal:m,destinatarios:JSON.stringify(T),fechaEnvio:new Date}});c&&await t.default.reporte.update({where:{id:c},data:{enviado:!0,fechaEnvio:new Date}});let _=Date.now()-f;return{success:!0,data:{tipoBoletin:l,contratoId:s,entregaId:C.id,canal:m,destinatarios:T,cliente:E.Cliente.nombre,responseTime:_,enviado:!0}}}catch(a){let e=a instanceof Error?a.message:String(a);try{await t.default.entrega.create({data:{contratoId:s,tipoBoletin:l,estado:"fallido",canal:m||"whatsapp",error:e}})}catch{}return{success:!1,error:`enviar_entrega fallo: ${e}`}}}e.s(["default",0,{handler:c},"run",0,c],781835)}];
