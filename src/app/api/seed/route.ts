...
const EJES_TEMATICOS = [
  ...
  // ─── Dominio 5: Sistemas de Vida, Tierra y Territorio ────────
  // Perspectiva andino-amazónica: agua, tierra, biodiversidad, clima y territorio
  // como sistema interconectado (buen vivir / suma qamaña), no como "medio ambiente"
  // externo al ser humano. Incorpora soberanía alimentaria y gestión territorial.
  { nombre: 'Sistemas de Vida, Tierra y Territorio', slug: 'sistemas-vida-territorio', icono: '🌍', color: '#22c55e', orden: 5, tipo: 'estructural', keywords: 'sistemas de vida,territorio,tierra,medio ambiente,deforestación,incendios forestales,biodiversidad,parque nacional,Madidi,contaminación,aire,agua,suelo,residuos,cambio climático,sequía,Pilcomayo,plomo,INTI,saneamiento de tierras,gestión territorial,ordenamiento territorial,tenencia de tierra,Chiquitanía,Amazonía,Pachamama,glaciar,deshielo,soberanía alimentaria,suma qamaña,buen vivir,vivir bien,TCO,tierra comunitaria,sistemas de riego,cuenca hidrográfica', descripcion: 'Sistemas de vida interconectados: deforestación e incendios, biodiversidad y áreas protegidas, contaminación, cambio climático, gestión territorial y tenencia de tierra. Perspectiva andino-amazónica (buen vivir).' },
...
const SUBCLASIFICACIONES = [
  ...
  // ─── Dominio 5: Sistemas de Vida, Tierra y Territorio (5 subtemas)
  { parentId: 'sistemas-vida-territorio', nombre: 'Deforestación e incendios', slug: 'svt-deforestacion-incendios', icono: '🔥', color: '#ef4444', orden: 1, descripcion: 'Deforestación e incendios', keywords: 'deforestación,tasa,incendios forestales,hectáreas,quemas,punto de calor,Chapa' },
  { parentId: 'sistemas-vida-territorio', nombre: 'Biodiversidad y áreas protegidas', slug: 'svt-biodiversidad-protegidas', icono: '🌿', color: '#22c55e', orden: 2, descripcion: 'Biodiversidad y áreas protegidas', keywords: 'parque nacional,Madidi,especies amenazadas,macheteo,controversia' },
  { parentId: 'sistemas-vida-territorio', nombre: 'Contaminación', slug: 'svt-contaminacion', icono: '☠️', color: '#ef4444', orden: 3, descripcion: 'Contaminación', keywords: 'aire,agua,suelo,residuos sólidos,Pilcomayo,plomo,niveles tóxicos' },
  { parentId: 'sistemas-vida-territorio', nombre: 'Cambio climático', slug: 'svt-cambio-climatico', icono: '🌡️', color: '#22c55e', orden: 4, descripcion: 'Cambio climático', keywords: 'eventos climáticos extremos,sequía,altiplano,cosechas,cambio climático' },
  { parentId: 'sistemas-vida-territorio', nombre: 'Gestión territorial y tenencia de tierra', slug: 'svt-gestion-territorial', icono: '🗺️', color: '#22c55e', orden: 5, descripcion: 'Gestión territorial y tenencia de tierra', keywords: 'ordenamiento territorial,tenencia de tierra,INTI,saneamiento tierras,TCO,tierra comunitaria,concesión' },
