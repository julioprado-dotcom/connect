...
const INDICADORES_TIER1 = [
  ...
  // Divisas internacionales — comercio exterior boliviano
  {
    slug: 'fx-eur-usd',
    nombre: 'Euro / Dólar',
    categoria: 'monetario',
  ...
  {
    slug: 'fx-pyg-usd',
    nombre: 'Guaraní Paraguayo / Dólar',
    categoria: 'monetario',
    fuente: 'Yahoo Finance',
