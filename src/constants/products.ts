...
8. IDENTIDAD DEL PRODUCTO AL FINAL. NO inicies el producto con un parrafo institucional sobre DECODEX ("X es un producto de DECODEX Bolivia, un observatorio que monitorea..."). El producto DEBE iniciar directamente con el contenido periodistico. La identidad institucional, si se incluye, va UNICAMENTE al FINAL del producto, como un cierre breve (maximo 2 lineas).

9. IDIOMA. Todo el contenido generado debe estar en espanol boliviano. Si una mencion esta en ingles u otro idioma, traducela pero indica la fuente original.
...
- La seccion de indicadores DEBE llamarse "Indicadores de presencia"`,
...
- La seccion "Indicadores de presencia" lista indicadores cuantitativos con fuentes
...
- ANTI-REPETICION: Cada dato o cifra aparece UNA SOLA VEZ. El "Balance general" y los "Hits del dia" no deben repetir la misma informacion. La seccion "Miss del dia" aporta informacion NUEVA (lo que NO se cubrio), no repite lo ya dicho.
- El "resumen" final NO debe parafrasear el balance general. Si el balance ya dijo todo, omite el resumen final.`,
...
- Estructura: Analisis de menciones > Actores clave > Indicadores de presencia > Sintesis
...
- RECUERDA: La "Sintesis" NO debe repetir datos ya mencionados en "Analisis de menciones" ni "Actores clave". Debe aportar una lectura de conjunto NUEVA.
- ANTI-REPETICION: Cada dato, cita o cifra aparece UNA SOLA VEZ en todo el producto. Las secciones "Analisis de menciones", "Actores clave" y "Sintesis" no deben reiterar la misma informacion con palabras distintas. Si un dato ya aparecio en "Analisis", no lo repitas en "Sintesis".
...
- Estructura: Resumen ejecutivo > Radiografia semanal > Ejes con mayor actividad > Actores destacados > Indicadores de presencia
...
- Estructura: Datos generales > Trayectoria > Posicionamiento reciente > Menciones en medios > Indicadores de presencia > Evaluacion
...
- Fechas en formato es-BO (America/La_Paz)
- PROHIBIDO mencionar "Este tema ha activado ejes como..." al final de cada tema. Los ejes tematicos son informacion interna del sistema, no se reproducen en el texto. Refleja el contenido tematico en la narrativa naturalmente.
- La seccion de indicadores DEBE llamarse "Indicadores de presencia"`,
...
- Estructura: Panorama del eje > Menciones destacadas > Actores > Indicadores de presencia > Tendencia
